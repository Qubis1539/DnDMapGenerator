...
const ControlPanel = ({ settings, setSettings }) => {
        ...
        return (
            <>
                <input
                    ...
                    onChange={(e) => {
                        handleChangeSetting(mapType, mapTypeSetting, e.target.checked);
                    }}
                />
            </>
        );
        ...
        return (
            <>
                <input
                    ...
                    onChange={(e) => {
                        handleChangeSetting(mapType, mapTypeSetting, e.target.value);
                    }}
                />
                <input
                    type="range"
                    ...
                    max="100"
                    value={settings.mapTypeSettings[mapType][mapTypeSetting]}
                    onChange={(e) => handleChangeSetting(mapType, mapTypeSetting, e.target.value)}
                />
            </>
        );
    };
    const mapTypeControl = (e) => {
        ...
        return Object.keys(settings.mapTypeSettings[mapType]).map((mapTypeSetting) => {
            return (
                <div className="controlPanel__field controlPanel__row" key={mapTypeSetting}>
    ...
    const controlPanelClasses = cn("controlPanel__container", { show: settings.UI.showControls });
    return (
                ...
                <div className="controlPanel__field">
                    ...
                    <div className="controlPanel__row mapSizeController">
                        <div className="mapSizeController__field">
                            <input type="number" placeholder="X Cells" value={settings.mapSize.x} />
                            <input
                                type="range"
                                min="1"
                                max="100"
                        ...
                        x
                        <div className="mapSizeController__field">
                            <input type="number" placeholder="Y Cells" value={settings.mapSize.y} />
                            <input
                                type="range"
                                min="1"
                                max="100"
                ...
                <div className="controlPanel__field">
                    ...
                    >
                        {Object.keys(settings.mapTypeSettings).map((type) => {
                            return (
                                <option key={type} value={type} defaultValue={true}>
                                    {type}
                                </option>
                            );
                        })}
